...
try:
    ...
    try:
        # Try loading from local MLflow tracking or pre-packaged local development models
        import glob
        local_model_paths = (
        ...
        if local_model_paths:
            ...
            raise Exception("No model found in local serving/model or mlruns")
...
try:
    ...
    if not os.path.exists(feature_file):
        feature_file = os.path.abspath(os.path.join(MODEL_DIR, "..", "feature_columns.txt"))
